...
setInterval(function() {
    ...
    request(options, function(error, response) {
		...
		//send to pg
		var thisQuery = "INSERT INTO public.devorders (order_id, products, istable) VALUES ("+auth1.purchases[0].globalPurchaseNumber+", '" +JSON.stringify(auth1.purchases[0].products)+"',"+doesOrderContainTable(auth1.purchases[0].products)+")"
